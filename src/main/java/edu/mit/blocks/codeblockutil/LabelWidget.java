...
/**
This class can be used to edit the text features when changing variable names on the blocks. You can change the color and other stuff etc.
**/
public abstract class LabelWidget extends JComponent {
    ...
    public LabelWidget(String initLabelText, Color fieldColor, Color tooltipBackground) {
        ...
        textField.setForeground(Color.red);//white text
        textField.setBackground(Color.black);//background matching block color
