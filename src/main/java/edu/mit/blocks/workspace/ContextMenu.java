...
public class ContextMenu extends PopupMenu implements ActionListener {
	...
	private static ContextMenu deleteBlockMenu = new ContextMenu();
	...
	private static MenuItem deleteBlockItem;
	private final static String DELETE_BLOCK_BLOCK = "DELETEBLOCK";
	private static boolean deleteBlockMenuInit = false;
	...
	/** 
	 *Initializes the context menu for the Delete button
	 *
	 */
	//public static void initDeleteBlockMenu(){
		
	//	deleteBlockItem = new MenuItem("Delete Block");
	//	deleteBlockItem.setActionCommand(DELETE_BLOCK_BLOCK);
	//	deleteBlockItem.addActionListener(rndBlockMenu);
	//	deleteBlockMenu.add(deleteBlockItem);
		
	//	deleteBlockMenuInit = true;
    ...
    private static void initAddCommentMenu() {
		...
		deleteBlockItem.setActionCommand(DELETE_BLOCK_BLOCK);
		deleteBlockItem.addActionListener(rndBlockMenu);
		addCommentMenu.add(deleteBlockItem);
    ...
    private static void initRemoveCommentMenu() {
		...
		deleteBlockItem.setActionCommand(DELETE_BLOCK_BLOCK);
		deleteBlockItem.addActionListener(rndBlockMenu);
		removeCommentMenu.add(deleteBlockItem);
    ...
    public static PopupMenu getContextMenuFor(Object o) {
        if (o instanceof RenderableBlock) {
            ...
            } else if (!((RenderableBlock) o).hasComment()) {
    ...
    public void actionPerformed(ActionEvent a) {
        ...
        } else if (a.getActionCommand() == DELETE_BLOCK_BLOCK){
		
			if (activeComponent != null && activeComponent instanceof RenderableBlock) {
				((RenderableBlock) activeComponent).deleteB();
			}
